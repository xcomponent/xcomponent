...
namespace XComponent.DealCapture.Common.Senders
{
    ...
    {
		private static ValidationErrorErrorOnValidationErrorTransactionSender m_validationErrorErrorOnValidationErrorTransactionSender;
        
        public static ValidationErrorErrorOnValidationErrorTransactionSender ValidationErrorErrorOnValidationErrorTransactionSender
        {
            get
            {
                if ((m_validationErrorErrorOnValidationErrorTransactionSender == null))
                {
                    m_validationErrorErrorOnValidationErrorTransactionSender = new ValidationErrorErrorOnValidationErrorTransactionSender();
                }
                return m_validationErrorErrorOnValidationErrorTransactionSender;
            }
        }
		...
		private static InstrumentSnapshotInstrumentSnapshotOnMappingTransactionSender m_instrumentSnapshotInstrumentSnapshotOnMappingTransactionSender;
        
        public static InstrumentSnapshotInstrumentSnapshotOnMappingTransactionSender InstrumentSnapshotInstrumentSnapshotOnMappingTransactionSender
        {
            get
            {
                if ((m_instrumentSnapshotInstrumentSnapshotOnMappingTransactionSender == null))
                {
                    m_instrumentSnapshotInstrumentSnapshotOnMappingTransactionSender = new InstrumentSnapshotInstrumentSnapshotOnMappingTransactionSender();
                }
                return m_instrumentSnapshotInstrumentSnapshotOnMappingTransactionSender;
            }
        }
		private static ReferentialUpdatedInstrumentSnapshotOnMappingTransactionSender m_referentialUpdatedInstrumentSnapshotOnMappingTransactionSender;
        
        public static ReferentialUpdatedInstrumentSnapshotOnMappingTransactionSender ReferentialUpdatedInstrumentSnapshotOnMappingTransactionSender
        {
            get
            {
                if ((m_referentialUpdatedInstrumentSnapshotOnMappingTransactionSender == null))
                {
                    m_referentialUpdatedInstrumentSnapshotOnMappingTransactionSender = new ReferentialUpdatedInstrumentSnapshotOnMappingTransactionSender();
                }
                return m_referentialUpdatedInstrumentSnapshotOnMappingTransactionSender;
            }
        }
