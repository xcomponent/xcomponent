...
namespace XComponent.BenchSimpleFork.TriggeredMethod
{
    public partial class TriggeredMethodContext : ICustomTriggeredMethodContext
    {
        enum DefaultLogger
        {
            BenchSimpleForkDefaultLogger
        }

        private IComponentLogger _defaultLogger = XComponent.Common.Logger.Managers.ComponentLoggerManager<DefaultLogger>.GetComponentLogger(DefaultLogger.BenchSimpleForkDefaultLogger, ComponentHelper.COMPONENT_NAME);
