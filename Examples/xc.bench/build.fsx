...
let generatedDir = "./benchsimplefork/generated/"
...
Target "Compile" (fun _ ->    
    ...
    let result = ExecProcess (fun info ->
                    ...
                    info.Arguments <- "--build --project=\"benchsimplefork\BenchSimpleFork_Model.xcml\""
                    ) 
    ...
    !! "benchsimplefork\BenchRunner/BenchRunner.sln"
    |> MSBuildRelease buildClientAppDir "Build"
    |> Log "Benchmark runner application build output: "
)
...
Target "Generate" (fun _ ->
    ...
    ;"start \"\" XCStudio.exe \"" + Path.Combine(__SOURCE_DIRECTORY__, "benchsimplefork\\BenchSimpleFork_Model.xcml") + "\""
    ;"popd" |]
    ...
    ;"start \"\" XCRuntime.exe \"" + Path.Combine(__SOURCE_DIRECTORY__, "build\\exportMicroservice\\xcassemblies\\benchsimplefork-BenchMicroservice.xcr") + "\""
    ;"popd"|]
