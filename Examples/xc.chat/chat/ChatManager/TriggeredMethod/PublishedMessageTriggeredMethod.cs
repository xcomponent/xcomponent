...
namespace XComponent.ChatManager.TriggeredMethod
{
    ...
    {
        public static void ExecuteOn_Published_Through_PublishMessage(XComponent.ChatManager.UserObject.PublishedMessage publishedMessage, XComponent.ChatManager.UserObject.PublishedMessage publishedMessage_PublicMember, object object_InternalMember, RuntimeContext context, IPublishMessagePublishedMessageOnPublishedPublishedMessageSenderInterface sender)
        {
