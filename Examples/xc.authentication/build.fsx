...
let generatedDir = "./authenticationservice/generated/"
...
Target "Compile" (fun _ ->    
    ...
    let result = ExecProcess (fun info ->
                    ...
                    info.Arguments <- "--build --project=\"authenticationservice\\authenticationservice_Model.xcml\""
                    ) 
    ...
    !! "authenticationservice\AuthenticationConsoleApp/AuthenticationConsoleApp.sln"
    |> MSBuildRelease buildClientAppDir "Build"
    |> Log "Authentication client application build output: "
)
...
Target "Generate" (fun _ ->
    ...
    ;"start \"\" XCStudio.exe \"" + Path.Combine(__SOURCE_DIRECTORY__, "authenticationservice\\authenticationservice_Model.xcml") + "\""
    ;"popd" |]
    ...
    ;"start \"\" XCRuntime.exe \"" + Path.Combine(__SOURCE_DIRECTORY__, "build\\exportMicroservice\\xcassemblies\\authenticationservice-authenticationService.xcr") + "\""
    ;"popd"|]
    ...
    ;"start \"\" AuthenticationConsoleApp.exe"
    ;"popd"|]
...
Target "Help" (fun _ ->
    List.iter printfn [
      "xcomponent.authentication build usage: "      
      ""
      "build All"      
      ""                  
      ""]
