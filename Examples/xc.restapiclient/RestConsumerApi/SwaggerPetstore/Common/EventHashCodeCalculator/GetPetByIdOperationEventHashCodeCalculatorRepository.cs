...
namespace XComponent.SwaggerPetstore.Common.EventHashCodeCalculator
{
	public class GetPetByIdOperationEventHashCodeCalculatorRepository : IEventHashCodeCalculatorRepository
	{
		...
		public GetPetByIdOperationEventHashCodeCalculatorRepository()
		{
			...
			_calculators.Add(22, new XComponent.SwaggerPetstore.Common.EventHashCodeCalculator.GetPetByIdOperation.ErrorResponseEventHashCodeCalculator());
			_calculators.Add(48, new XComponent.SwaggerPetstore.Common.EventHashCodeCalculator.GetPetByIdOperation.SuccessResponseEventHashCodeCalculator());
		}
