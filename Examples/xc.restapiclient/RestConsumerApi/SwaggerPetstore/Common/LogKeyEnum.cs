...
namespace XComponent.SwaggerPetstore.Common
{
    ...
    public static class Loggers
    {
        ...
        static Loggers()
        {
			_loggerByLogKeyEnum.Add(LogKeyEnum.SwaggerPetstoreLogger, ComponentLoggerManager<LogKeyEnum>.GetComponentLogger(LogKeyEnum.SwaggerPetstoreLogger, ComponentHelper.COMPONENT_NAME));
        }
