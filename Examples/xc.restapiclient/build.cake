...
var modelPath = Argument("modelPath", "RestConsumerApi/RestConsumerApi_Model.xcml");
...
Task("Build")
  .Does(() =>
{
  foreach(var solution in GetFiles("./RestConsumerApi/**/*.sln"))
  {
    NuGetRestore(solution, new NuGetRestoreSettings { NoCache = true });
  }
  XcBuildBuild("./" + modelPath, buildConfiguration, "Dev", "VS2015", getXCBuildExtraParam());
  BuildNETSolution(@"RestConsumerApi\ConsoleApplication\ConsoleApplication.sln");
