...
Target "Compile" (fun _ ->    
    ...
    let result = ExecProcess (fun info ->
                    ...
                    info.Arguments <- "--build --project=\"OrderProcessing\OrderProcessing_Model.xcml\""
                    ) 
    ...
    !! "OrderProcessing\OrderProcessingClient/OrderProcessingClient.sln"
    |> MSBuildRelease buildClientAppDir "Build"
    |> Log "Order processing client application build output: "
)
...
Target "Help" (fun _ ->
    List.iter printfn [
      "xcomponent.orderprocessing build usage: "      
      ""
      "build All"      
      ""                  
      ""]
